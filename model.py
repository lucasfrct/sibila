...
class Model:
    ...
    def embedding(self, data = ""):
        embedding = ollama.embeddings(model='llama2', prompt=data)
    ...
    def generate(self):
        ...
        for i, chunk in enumerate(self.chunks):
            self.embeddings.append(self.embedding(chunk))
    ...
    def record(self, chunks, metadatas, embeddings):
        ...
        print(f"        - - - > Dados do document {self.doc.name} gravados com suceeso!")
    ...
    def query(self, question):
        query_embedding = self.embedding(question)
    ...
    def question(self, question):
        ...
        chat_completion = self.completion(self.prompt_generic(self.search(question)), question)
        return chat_completion["message"]["content"]

    def completion(self, prompt, question):
         return ollama.chat(
            model="llama2",
            messages=[
